...
export function StillHaveQuestions({isContactPage = false}) {
    ...
    return (
        <SectionLayout noPadding containerClasses={"bg-gradient-to-b from-obsidian-100 to-obsidian-200"} className={`text-white flex flex-col gap-8 relative overflow-hidden ${isContactPage ? "pb-12 md:pb-20 pt-28 md:pt-56" : "py-12 md:py-20"}`}>
