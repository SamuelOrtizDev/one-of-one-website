    ...
    return (
        <SectionLayout style={{backgroundImage: `url(${bg.src})`}}>
            <span className="flex flex-col w-fit mx-auto items-center text-center gap-4 md:gap-6 relative">
                <h2 className="text-3xl md:text-5xl">Unique Stories, <span className="px-2 py-2 text-white font-bold bg-oBlue-200">Turned into Art.</span></h2>
                <p>What our customers had to say.</p>
